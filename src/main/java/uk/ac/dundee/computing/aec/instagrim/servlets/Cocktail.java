...
public class Cocktail extends HttpServlet {
    ...
    private void DisplayAllCocktails(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        java.util.LinkedList<CocktailStore> trending = cm.ReturnTrending(); //=cm.getcocktails -- when ready
