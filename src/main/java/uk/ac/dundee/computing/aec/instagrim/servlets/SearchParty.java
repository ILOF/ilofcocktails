 ...
 */
@WebServlet(name = "SearchParty", urlPatterns = { "/SearchParty" })
public class SearchParty extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		SearchCriteria = SearchCriteria.toLowerCase();
                ...
                java.util.LinkedList<PartyStore> Parties = cm.SearchNames(SearchCriteria);
